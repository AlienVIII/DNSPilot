...
Use this prompt for a new `[os]` lane session.
...
- Do not edit `crates/**` directly. If Core CLI is missing behavior, mock locally only if needed and record the request in `apps/[os]/[os]-core-cli-request.md`.
