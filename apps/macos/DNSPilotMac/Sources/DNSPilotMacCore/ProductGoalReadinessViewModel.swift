...
public struct ProductGoalReadinessViewModel: Equatable, Sendable {
    ...
    public static let defaultRows: [ProductGoalReadinessRow] = [
        ...
        ProductGoalReadinessRow(
            ...
            caveat: "True one-click system mutation needs a separate Power edition with a privileged helper."
        ),
        ProductGoalReadinessRow(
            id: "flush-dns",
            title: "Flush DNS",
            ...
            caveat: "Real cache flush requires admin authorization or a trusted helper outside the store-safe app."
        ),
        ProductGoalReadinessRow(
            id: "saved-domains",
